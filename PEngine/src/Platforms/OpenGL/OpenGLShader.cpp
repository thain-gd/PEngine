...
namespace PEngine
{
	...
	std::string OpenGLShader::ReadFile(const std::string& filepath)
	{
		...
		std::string result;
		// Will need to abstract later because different environments use different file systems
	...
	std::unordered_map<GLenum, std::string> OpenGLShader::PreProcess(const std::string& source)
	{
		...
		while (pos != std::string::npos)
		{
			...
			PE_CORE_ASSERT(ShaderTypeFromString(type), "Invalid shader type specific");
